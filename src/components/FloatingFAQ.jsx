...
function FloatingFAQ() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('resize', measureContentHeights)
  }, [])
  ...
  const faqs = [
    {
      ...
      answer: 'Desarrollo landing pages optimizadas, aplicaciones web modernas con React, y software personalizado para automatizar procesos de negocio.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      ...
      answer: 'Depende del alcance. Una landing page puede estar lista en 1-2 semanas, mientras que aplicaciones web complejas pueden tomar de 4 a 12 semanas.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      ...
      question: '¿Trabajas con tecnologías modernas?',
      answer: 'Sí, utilizo React, Node.js, Vite y las últimas tecnologías web. Enfoque en código limpio, escalable y de alto rendimiento.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      ...
      question: '¿Incluyes soporte post-lanzamiento?',
      answer: 'Absolutamente. Ofrezco soporte continuo, actualizaciones y mejoras para asegurar que tu proyecto siempre funcione perfectamente.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      ...
      answer: 'Simple: contacta conmigo, cuéntame tu proyecto, y te enviaré una propuesta personalizada con plazos y costos claros.'
    }
  ]

  return (
    <div className="floating-faq-wrapper">
      <div className="morphing-disclosure" ref={faqRef}>
        {faqs.map((faq, index) => (
          <details key={index} name="morph">
            <summary>
